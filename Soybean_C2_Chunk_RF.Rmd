...
```{r}
soy.cmp <- read.csv(here("Data_Prediction/Compress_2_Chunk", "Soybean_X_C2_1.csv"), row.names = 1)
```
...
```{r}
saveRDS(y.out,
        here("ModelMetaData_Prediction/Net_2_RF_Chunk", "Soybean_PredictedOutput_C2_Chunk_1.rds"))
```
output data as csv
```{r}
write.csv(y.out, here("ModelMetaData_Prediction/Net_2_RF_Chunk",  "Soybean_PredictedOutput_C2_Chunk_1.csv"), quote = F)
```
...
```{r}
write.csv(y.predresult.df, here("ModelMetaData_Prediction/Net_2_RF_Chunk",  "Soybean_PredictionAccuracy_RF_C2_Chunk_1.csv"), quote = F)
```